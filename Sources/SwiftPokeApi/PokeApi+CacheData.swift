...
public extension PokeApi {
    ...
    func getCachedResource<PokeApiData: ApiGetable>(_ type: PokeApiData.Type, id: Int, cachePolicy: URLRequest.CachePolicy? = nil) throws -> PokeApiData? {
        try getCachedResource(type, request: urlGetRequest(for: type, id: id, cachePolicy: cachePolicy))
    }

    func getCachedResource<PokeApiData: ApiGetable>(_ type: PokeApiData.Type, name: String, cachePolicy: URLRequest.CachePolicy? = nil) throws -> PokeApiData? {
